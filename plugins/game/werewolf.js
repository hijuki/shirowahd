...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "hillz-games.jpg"))) {
    thumbWW = fs.readFileSync(path.join(assetsPath, "hillz-games.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "hillz.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "hillz.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "hillz.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "hillz-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "hillz-winner.jpg"));
  }
} catch (e) {
