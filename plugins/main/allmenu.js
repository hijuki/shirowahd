  ...
  try {
    switch (allmenuVariant) {
      ...
      case 5: {
        ...
        const thumbnail = await _sharp(fs.readFileSync(config.assets["hillz"])).resize(300, 300).toBuffer()
        const qOrder = {
        ...
        const media4 = await prepareWAMessageMedia({ video: fs.readFileSync(config.assets["hillz-mp4"]), gifPlayback: true }, { upload: sock.waUploadToServer });
            ...
            message: {
              ...
              interactiveMessage: {
                ...
                contextInfo: {
                  ...
                  forwardingScore: 9,
                  forwardedNewsletterMessageInfo: {
                    newsletterJid: config.saluran?.id || "120363413208281480@newsletter",
                    newsletterName: config.saluran?.name || config.bot?.name || "SHIROWAHD",
                    serverMessageId: 127,
                  },
                },
                nativeFlowMessage: {
                  messageParamsJson: JSON.stringify({
                    ...
                    tap_target_configuration: { title: " X ", description: "bomboclard", canonical_url: "https://swhdhlz.my.id", domain: "shop.example.com", button_index: 0 },
                  }),
                  buttons: [
                    ...
                    {
                      name: "cta_url",
                      buttonParamsJson: JSON.stringify({ display_text: "Visit Website", url: getUploaderUrl(), merchant_url: getUploaderUrl() })
                    },
                  ]
                }
              }
              ...
              message: {
                orderMessage: {
                  ...
                  contextInfo: {
                    ...
                    forwardingScore: 9,
                    forwardedNewsletterMessageInfo: {
                      newsletterJid: "120363413208281480@newsletter",
                      newsletterName: "SHIROWAHD",
                      serverMessageId: 127,
                    },
                  },
                },
