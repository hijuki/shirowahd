import {
  ...
  getRandomReward,
  getProgressiveHint,
} from "./hillz-game-data.js";
import { getDatabase } from "./hillz-database.js";
import { addExpWithLevelCheck } from "./hillz-level.js";
import {
  getGameContextInfo,
  sendGamePreview,
  checkFastAnswer,
} from "./hillz-context.js";
import config from "../../config.js";
import fs from "fs";
import sharp from "sharp";
let fetchBuffer;
try {
  fetchBuffer = (await import("./hillz-utils.js")).fetchBuffer;
...
const games = new HillzGames();

export { HillzGames, games };
