...
/**
 * @typedef {Object} HillzApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} HillzApiProviderShape
 * @property {string} baseURL
 * @property {HillzApiAuthShape} [auth]
...
/**
 * @typedef {Object} HillzApiRequestOptions
...
/**
 * @typedef {Object} HillzApiMultipartFile
 ...
 */
class HillzApiProvider {
  /**
   * @param {HillzApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {HillzApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {HillzApiMultipartFile[]|Object<string, any>} [files]
   * @param {HillzApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends HillzApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends HillzApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends HillzApiProvider {
...
class ApiFaaProvider extends HillzApiProvider {
...
class HillzMainApiProvider extends HillzApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends HillzApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends HillzApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends HillzApiProvider {
...
class AzbryApiProvider extends HillzApiProvider {
...
class YuulabsApiProvider extends HillzApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends HillzApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends HillzApiProvider {
...
class HillzApiManager {
  ...
  /**
   * @param {string} name
   * @param {HillzApiProviderShape} cfg
   * @returns {HillzApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<HillzApiProviderShape>} cfg
   * @returns {HillzApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || HillzApiProvider;
...
const hillzApi = new HillzApiManager();

export { HillzApiManager, HillzApiProvider, hillzApi };
export default hillzApi;
