...
export const getBotPluginsDetailed = () => api('/api/bot/plugins/list')
export const auditBotPlugins = () => api('/api/bot/plugins/audit')
export const toggleBotPlugin = (target, disabled) => api('/api/bot/plugins/toggle', { method: 'POST', body: { target, disabled } })
export const setBotPluginRole = (target, role) => api('/api/bot/plugins/set-role', { method: 'POST', body: { target, role } })
export const setBotCategoryRole = (category, role) => api('/api/bot/plugins/set-category-role', { method: 'POST', body: { category, role } })
export const reloadBotPlugin = (target, all = false) => api('/api/bot/plugins/reload', { method: 'POST', body: { target, all } })
export const testBotPlugin = (target) => api('/api/bot/plugins/test', { method: 'POST', body: { target } })
export const getBotPluginErrors = () => api('/api/bot/plugins/errors')
export const clearBotPluginErrors = () => api('/api/bot/plugins/errors/clear', { method: 'POST' })
